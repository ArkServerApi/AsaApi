...
struct APrimalBotAIController : APrimalDinoAIController
{
	...
	// FUNCTION MISSING: APrimalBotAIController.StaticRegisterNativesAPrimalBotAIController()
	...
	// FUNCTION MISSING: APrimalBotAIController.ChangedAITarget_Implementation()
	...
	// FUNCTION MISSING: APrimalBotAIController.GetHasAttackPriority()
...
struct APrimalBotCharacter : APrimalDinoCharacter
{
	...
	// FIELD MISSING: APrimalBotCharacter.AlternateDinoRidingAnimation
	...
	// FIELD MISSING: APrimalBotCharacter.AlternateDinoRidingMoveAnimation
	...
	// FIELD MISSING: APrimalBotCharacter.RideableDinoClasses
	...
	// FIELD MISSING: APrimalBotCharacter.DefaultDinoRidingAnimation
	...
	// FIELD MISSING: APrimalBotCharacter.DefaultDinoRidingMoveAnimation
	// bool& bIsStationaryField() { return *GetNativePointerField<bool*>(this, "APrimalBotCharacter.bIsStationary"); }
	// FIELD MISSING: APrimalBotCharacter.bIsStationary
	...
	// FUNCTION MISSING: APrimalBotCharacter.GetDinoRidingMoveAnimation()
...
struct APrimalBuff : APrimalEmitterSpawnable
{
	...
	// BITFIELD MISSING: APrimalBuff.bEnabledCollisionNotify
	...
	// BITFIELD MISSING: APrimalBuff.bWasDestroyed
	...
	// FUNCTION MISSING: APrimalBuff.ValidateGeneratedRepEnums(TArray<FRepRecord,TSizedDefaultAllocator<32>>&)
	...
	// FUNCTION MISSING: APrimalBuff.TemplateAllowActorSpawn(UWorld*,UE::Math::TVector<double>&,UE::Math::TRotator<double>&,FActorSpawnParameters&)
	...
	// FUNCTION MISSING: APrimalBuff.NetDeactivate_Implementation()
	...
	// FUNCTION MISSING: APrimalBuff.ResetBuffStart()
	...
	UMaterialInstanceDynamic* GetBuffPostprocessMaterial() { return NativeCall<UMaterialInstanceDynamic*>(this, "APrimalBuff.GetBuffPostprocessMaterial(AShooterPlayerController*)"); }
	...
	// FUNCTION MISSING: APrimalBuff.PreventInstigatorAttack(int)
	...
	// FUNCTION MISSING: APrimalBuff.OverrideCharacterWalkingVelocity(UE::Math::TVector<double>&,float&,float)
	...
	// FUNCTION MISSING: APrimalBuff.OverrideCharacterFlyingVelocity(UE::Math::TVector<double>&,UE::Math::TVector<double>&,float)
	...
	// FUNCTION MISSING: APrimalBuff.BPGetDinoNameColorOverride_Implementation(AShooterHUD*,FColor)
...
struct APrimalBuff_MissionData : APrimalBuff
{
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.StaticRegisterNativesAPrimalBuff_MissionData()
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.ValidateGeneratedRepEnums(TArray<FRepRecord,TSizedDefaultAllocator<32>>&)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.GetLifetimeReplicatedProps(TArray<FLifetimeProperty,TSizedDefaultAllocator<32>>&)
	...
	void UpdateBuffPersistentData_Implementation() { NativeCall<void>(this, "APrimalBuff_MissionData.UpdateBuffPersistentData_Implementation(bool,bool)"); }
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.ServerRequestStartMissionWithMissionTag_Implementation(FName,AMissionDispatcher*)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.ClientLoadMissionLevels_Implementation(FName)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.ClientUnloadMissionLevels_Implementation(FName)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.ClientMissionEvent_Implementation(AMissionType*,bool,bool)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.MultiUpdateMissionData_Bool_Implementation(FName,FName,bool)
	...
	// FUNCTION MISSING: APrimalBuff_MissionData.MultiUpdateMissionData_Int_Implementation(FName,FName,int)
...
struct APrimalBuff_Companion : APrimalBuff
{
	...
	// FUNCTION MISSING: APrimalBuff_Companion.StopCompanionEvent()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.ClientAllowVRTeleport_Implementation()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.ValidateGeneratedRepEnums(TArray<FRepRecord,TSizedDefaultAllocator<32>>&)
	...
	// FUNCTION MISSING: APrimalBuff_Companion.SetupForInstigator()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.MaxReactionLimitTimeout()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.Server_SetCompanionState_Implementation(ECompanionState::Type)
	// void OnRep_CompanionState() { NativeCall<void>(this, "APrimalBuff_Companion.OnRep_CompanionState()"); }
	// FUNCTION MISSING: APrimalBuff_Companion.OnRep_CompanionState()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.OnCompanionReactionPlayed_Implementation(FCompanionReactionData&,int)
	...
	// FUNCTION MISSING: APrimalBuff_Companion.AllowVRTeleport()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.GetUsablePriority_Implementation()
	...
	// FUNCTION MISSING: APrimalBuff_Companion.ClientToggleForceMonologue_Implementation(bool)
...
struct APrimalBuff_Grappled : APrimalBuff
{
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.ValidateGeneratedRepEnums(TArray<FRepRecord,TSizedDefaultAllocator<32>>&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.BeginPlay()
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.SetupDelegateBindingsForChar_Implementation(APrimalCharacter*,bool)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.Server_SetGrappleState_Implementation(unsignedchar,bool)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.OverrideCharacterWalkingVelocity(UE::Math::TVector<double>&,float&,float)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.OverrideCharacterFlyingVelocity(UE::Math::TVector<double>&,UE::Math::TVector<double>&,float)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetActorAttachParentChar(AActor*)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetGrappleTetherPullMaxVelocity_Implementation(APrimalCharacter*,FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetGrappleTetherPullAcceleration_Implementation(APrimalCharacter*,FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetGrappleTetherReleaseMaxVelocity_Implementation(APrimalCharacter*,FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetMaxTetherLength_Implementation(FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetTetherBreakLimit_OwnerPastCurrentLengthDelta_Implementation(FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetTetherBreakLimit_OwnerPastCurrentLengthForTime_Implementation(FGrappleTether&)
	...
	// FUNCTION MISSING: APrimalBuff_Grappled.GetTetherBreakLimit_GrappledActorAboveVelocity_Implementation(FGrappleTether&)
