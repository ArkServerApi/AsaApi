...
struct APrimalStructure : APrimalTargetableActor
{
    ...
    void SetHarvestingActive(bool bActive, bool bOverrideBaseHealth, float BaseHarvestHealthMult, bool bAssignToTribe, int AssignedToTribeID, bool bForceUpdateHealthOnActivate) { NativeCall<void, bool, bool, float, bool, int, bool>(this, "APrimalStructure.SetHarvestingActive(bool,bool,float,bool,int,bool)", bActive, bOverrideBaseHealth, BaseHarvestHealthMult, bAssignToTribe, AssignedToTribeID, bForceUpdateHealthOnActivate); }
