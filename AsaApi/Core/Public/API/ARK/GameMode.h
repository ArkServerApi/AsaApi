...
struct AShooterGameMode : APrimalGameMode
{
	...
	TSharedPtr<FWriteFileTaskInfo> SavePlayerData(UPrimalPlayerData* PlayerData, bool bSaveBackup, bool bForceSave) { return NativeCall<TSharedPtr<FWriteFileTaskInfo>, UPrimalPlayerData*, bool, bool>(this, "AShooterGameMode.SavePlayerData(UPrimalPlayerData*,bool,bool)", PlayerData, bSaveBackup, bForceSave); }
	...
	void SaveWorld(bool bForceSynchronous, bool bForceEvenIfSaveLoadIsDisabled) { NativeCall<void, bool, bool>(this, "AShooterGameMode.SaveWorld(bool,bool)", bForceSynchronous, bForceEvenIfSaveLoadIsDisabled); }
